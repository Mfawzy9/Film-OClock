      ...
      <div className="relative group">
        <button
          ...
          className="relative inline-block p-px font-semibold leading-6 text-white bg-gray-700
            ...
            duration-300 ease-in-out lg:hover:scale-105 lg:active:scale-95
            lg:hover:shadow-blue-600"
        >
          <span
          ...
          <span className="relative z-10 block px-4 py-3 rounded-2xl bg-neutral-950">
            <div className="relative z-10 flex items-center gap-3">
              <span
                className="transition-all duration-500 lg:group-hover:translate-x-1.5
